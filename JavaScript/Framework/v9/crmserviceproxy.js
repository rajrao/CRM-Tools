...
Microsoft.Crm.Client.Core.Models.FormModel = function() {
    ...
    this.$i_1 = new (Microsoft.Crm.Client.Core.Framework.TypedDictionary$1.$$(Microsoft.Crm.Client.Core.Framework.TypedDictionary$1.$$(Microsoft.Crm.Client.Core.Models.Validation.IIsRequiredValidator)))();
...
Microsoft.Crm.Client.Core.Models.FormModel.prototype = {
    ...
    get_userCurrencyPrecision: function() {
        var $v_0 = Microsoft.Crm.Client.Core.Storage.DataApi.DataSource.$4.$C_0.get_externalContext()['transactioncurrencybyid'];
        var $v_1 = $v_0.get_item(this.get_transactionCurrencyId());
        return ($v_1) ? $v_1.get_currencyPrecision() : Microsoft.Crm.Client.Core.Storage.DataApi.DataSource.$4.$C_0.get_UserSettings().get_numberFormatInfo()['CurrencyDecimalDigits'];
    },
    ...
    getValidator: function(fieldName, validatorType) {
        var $v_0 = this.$i_1.get_item(fieldName);
        if ($v_0) {
    ...
    setValidator: function(fieldName, validatorType, validator) {
        var $v_0 = this.$i_1.get_item(fieldName);
        if (!$v_0) {
            $v_0 = this.$i_1.set_item(fieldName, new (Microsoft.Crm.Client.Core.Framework.TypedDictionary$1.$$(Microsoft.Crm.Client.Core.Models.Validation.IIsRequiredValidator))());
        }
        ...
        switch (attributeMetadata.get_type()) {
            case 8:
                switch (attributeMetadata.get_precisionSource()) {
                    ...
                    case 1:
                        return Microsoft.Crm.Client.Core.Storage.DataApi.DataSource.$4.$C_0.get_organizationSettings().get_pricingDecimalPrecision();
                    default:
...
Microsoft.Crm.Client.Core.Models.RecordModel = function(record, isNewRecord) {
    this.$7_2 = Microsoft.Crm.Client.Core.Storage.DataApi.DataSource.$4;
...
Microsoft.Crm.Client.Core.Models.RecordModel.prototype = {
    ...
    get_namedReference: function() {
        if (_Script.isNullOrUndefined(this.$G_2)) {
            this.$G_2 = this.$0_2.get_actionableIdentifier();
            if (_Script.isNullOrUndefined(this.$G_2.Name)) {
                var $v_0 = Microsoft.Crm.Client.Core.Storage.DataApi.DataSource.$4.$I_0.getEntityMetadata(this.$G_2.get_modelType());
                if (!_Script.isNullOrUndefined($v_0)) {
                    this.$G_2.Name = this.$0_2.getValue($v_0.get_primaryNameAttribute());
                }
            }
        }
        return this.$G_2;
    ...
    get_activityPartyRecord: function() {
        if (_Script.isNullOrUndefined(this.$z_2)) {
            if (_Script.isNullOrUndefined(this.$G_2)) {
                this.$G_2 = this.$0_2.get_actionableIdentifier();
                if (_Script.isNullOrUndefined(this.$G_2.Name)) {
                    var $v_3 = Microsoft.Crm.Client.Core.Storage.DataApi.DataSource.$4.$I_0.getEntityMetadata(this.$G_2.get_modelType());
                    if (!_Script.isNullOrUndefined($v_3)) {
                        this.$G_2.Name = this.$0_2.getValue($v_3.get_primaryNameAttribute());
                    }
                }
            }
            var $v_0 = { partyid: this.$G_2 };
            var $v_1 = { partyid: 6 };
    ...
    get_isDisabled: function() {
        ...
        if (Microsoft.Crm.Client.Core.Storage.Common.ObjectModel.OptionMetadata.isInstanceOfType($v_0)) {
            ...
            if (this.$0_2.get_actionableIdentifier().LogicalName === 'knowledgearticle') {
                ...
                if ($v_1 === 2 || $v_1 === 3) {
                    var $v_2 = this.$7_2.get_userContext().get_rolePrivileges();
    ...
    reformatValue: function(record, fieldName, allDayDisplay) {
        if (!_Script.isUndefined(allDayDisplay) && !Microsoft.Crm.Client.Core.Framework._String.isNullOrWhiteSpace(fieldName)) {
            if (allDayDisplay) {
                this.$n_2[fieldName] = true;
            }
            else {
                this.$n_2[fieldName] = false;
            }
        }
                ...
                $$t_B.getFieldRequiredLevel(fieldName).then(function($p2_0) {
                    ...
                    if (!$v_1) {
                        ...
                        if ($v_2 && $p1_0.get_isSecured()) {
                            $v_3 = isCreateExperience || Microsoft.Crm.Client.Core.Storage.DataApi.DataSource.$4.$C_0.hasAttributeAccessRights($p1_0, 2, $$t_B.$0_2);
                        }
                        switch (validatorType) {
                            ...
                            case 8:
                                ...
                                break;
                            case 9:
                                $v_1 = new Microsoft.Crm.Client.Core.Models.Validation.MultiSelectPicklistValidator($v_2, $v_3);
                                break;
                            default:
    ...
    onRecordChanged: function(sender, eventArgs) {
        ...
        if (eventArgs.get_sourceStore() === 1) {
            this.$m_2 = eventArgs.get_retrieveState();
        }
    ...
    getAttributeFormat: function(fieldName) {
        var $v_0 = this.$7_2.get_metadataCache().getAttributeMetadata(this.$0_2.get_actionableIdentifier().LogicalName, fieldName);
    ...
    $Q_2: function($p0, $p1, $p2) {
        ...
        var $v_1 = this.$7_2.get_metadataCache().getAttributeMetadata(this.$0_2.get_actionableIdentifier().LogicalName, $p1);
        return this.$Y_2.formatFieldValue($v_0, $p1, $p2, $v_1);
    },
    ...
    getFieldAttributeValues: function(fieldName, valueNames) {
        ...
        this.$1M_2(fieldName).then(function($p1_0) {
            ...
            for (var $v_2 = 0; $v_2 < valueNames.length; $v_2++) {
                $v_1[valueNames[$v_2]] = $$t_7.$2m_2(valueNames[$v_2], $p1_0);
            }
            $v_0.resolve($v_1);
        }, function($p1_0) {
            $v_0.reject($p1_0);
    ...
    $2t_2: function($p0) {
        ...
        if ($v_0) {
            ...
            switch ($v_1) {
                case 3:
                case 4:
                    return this.$7_2.get_userContext().get_UserSettings().get_numberFormatInfo()['NumberDecimalDigits'];
                case 8:
                    return this.get_userCurrencyPrecision();
            }
        }
    ...
    $1u_2: function($p0, $p1) {
        ...
        if ($p0.hasField('transactioncurrencyid') || $p0.hasFieldType(8)) {
            ...
            if (_Script.isNullOrUndefined($v_0) && $p1) {
                var $v_1 = this.$7_2.get_userContext().getDefaultTransactionCurrency();
                if (!_Script.isNullOrUndefined($v_1)) {
                    ...
                    this.$2I_2('transactioncurrencyid');
            ...
            if (!_Script.isNullOrUndefined($v_0) && this.$0_2.get_fieldTypes()['transactioncurrencyid'] === 6) {
                ...
                if (_Script.isNullOrUndefined($v_2)) {
                    ...
                    $v_2 = this.$7_2.get_userContext().getTransactionCurrencySymbol($v_3);
                }
    ...
    $1M_2: function($p0) {
        ...
        this.$7_2.retrieveMultipleAttributeMetadata($v_3, this.get_$1Z_2()).then(function($p1_0) {
            ...
            if (!_Script.isNullOrUndefined($$t_D.$2_2)) {
                ...
                $$t_D.$7_2.retrieveMultipleAttributeMetadata($v_3, $$t_D.get_$1Z_2()).then(function($p2_0) {
...
Microsoft.Crm.Client.Core.Models.Validation.CurrencyValidator.prototype = {
    ...
    copy: function() {
        return new Microsoft.Crm.Client.Core.Models.Validation.CurrencyValidator(this.$A_0, this.$D_0, this.$t_1);
    },
...
Microsoft.Crm.Client.Core.Models.Validation.DateTimeValidator.prototype = {
    ...
    get_errorMessage: function() {
        return String.format(this.getLocalizedMessage('L_Decimal_Error_Message_FormatString_Text'), Microsoft.Crm.Client.Core.Storage.Common.CrmFormatter.get_instance().formatShortDateTimeValue(this.$j_1, this.$c_1));
    },
    
    copy: function() {
        return new Microsoft.Crm.Client.Core.Models.Validation.DateTimeValidator(this.$A_0, this.$D_0, this.$c_1, this.$j_1);
    },
...
Microsoft.Crm.Client.Core.Models.Validation.DecimalValidator.prototype = {
    ...
    get_errorMessage: function() {
        return String.format(this.getLocalizedMessage('L_Decimal_Error_Message_FormatString_Text'), Microsoft.Crm.Client.Core.Storage.Common.CrmFormatter.get_instance().formatDecimalValue(this.$F_1, this.$R_1), Microsoft.Crm.Client.Core.Storage.Common.CrmFormatter.get_instance().formatDecimalValue(this.$E_1, this.$R_1));
    },
    ...
    copy: function() {
        return new Microsoft.Crm.Client.Core.Models.Validation.DecimalValidator(this.$A_0, this.$D_0, this.$F_1, this.$E_1, this.$R_1);
    },
    ...
    validate: function(value, isValueChanging, isDisabled) {
        ...
        if ($v_0.get_isValueValid()) {
            ...
            if ($v_2) {
                ...
                $v_1 = $v_4 && $v_3 >= this.$F_1 && $v_3 <= this.$E_1;
                value = ($v_1) ? $v_3 : value;
            }
            else {
                value = null;
...
Microsoft.Crm.Client.Core.Models.Validation.EmailAddressValidator.prototype = {
    ...
    copy: function() {
        return new Microsoft.Crm.Client.Core.Models.Validation.EmailAddressValidator(this.$A_0, this.$D_0);
    },
    ...
    $30_1: function($p0) {
        var $v_0 = $p0;
        return Microsoft.Crm.Client.Core.Models.Validation.EmailAddressValidator.$1y.test($v_0) || this.$31_1($v_0);
    },
    ...
    $31_1: function($p0) {
        ...
        if (!$v_0 && $v_1 !== -1 && $v_1 > 1) {
            ...
            if (!Microsoft.Crm.Client.Core.Models.Validation.EmailAddressValidator.$21.test($v_2) && Microsoft.Crm.Client.Core.Models.Validation.EmailAddressValidator.$1y.test($v_3)) {
                return true;
            }
        }
        return false;
...
Microsoft.Crm.Client.Core.Models.Validation.IntegerValidator = function(isRequired, hasUserReadPermission, minValue, maxValue) {
    ...
    this.$F_1 = minValue;
    this.$E_1 = maxValue;
    this.$1e_1 = String.format(this.getLocalizedMessage('L_Integer_Error_Message_FormatString_Text'), Microsoft.Crm.Client.Core.Storage.Common.CrmFormatter.get_instance().formatIntegerValue(this.$F_1), Microsoft.Crm.Client.Core.Storage.Common.CrmFormatter.get_instance().formatIntegerValue(this.$E_1));
}
Microsoft.Crm.Client.Core.Models.Validation.IntegerValidator.prototype = {
    ...
    copy: function() {
        return new Microsoft.Crm.Client.Core.Models.Validation.IntegerValidator(this.$A_0, this.$D_0, this.$F_1, this.$E_1);
    },
...
Microsoft.Crm.Client.Core.Models.Validation.IsRequiredValidator = function(isRequired, hasUserReadPermission) {
    this.$A_0 = isRequired;
    this.$D_0 = hasUserReadPermission;
}
Microsoft.Crm.Client.Core.Models.Validation.IsRequiredValidator.prototype = {
    ...
    copy: function() {
        return new Microsoft.Crm.Client.Core.Models.Validation.IsRequiredValidator(this.$A_0, this.$D_0);
    },
...
Microsoft.Crm.Client.Core.Models.Validation.MoneyValidator.prototype = {
    ...
    copy: function() {
        return new Microsoft.Crm.Client.Core.Models.Validation.MoneyValidator(this.$A_0, this.$D_0, this.$F_1, this.$E_1, this.$R_1, this.$s_2);
    },
...
Microsoft.Crm.Client.Core.Models.Validation.UrlValidator.prototype = {
    ...
    copy: function() {
        return new Microsoft.Crm.Client.Core.Models.Validation.UrlValidator(this.$A_0, this.$D_0);
    },
    ...
    validate: function(value, isValueChanging, isDisabled) {
        ...
        if ($v_0.get_isValueValid()) {
            ...
            $v_0.set_isValueValid($v_1);
            $v_0.set_validatedValue(($v_4) ? this.$2K_1($v_3) : '');
            $v_0.set_errorMessage($v_2);
        }
        return $v_0;
    },
...
Microsoft.Crm.Client.Core.Models.Validation.MultiSelectPicklistValidator = function(isRequired, hasUserReadPermission) {
    Microsoft.Crm.Client.Core.Models.Validation.MultiSelectPicklistValidator.initializeBase(this, [ isRequired, hasUserReadPermission ]);
}
Microsoft.Crm.Client.Core.Models.Validation.MultiSelectPicklistValidator.prototype = {
    
    copy: function() {
        return new Microsoft.Crm.Client.Core.Models.Validation.MultiSelectPicklistValidator(this.$A_0, this.$D_0);
    },
    
    validate: function(value, isValueChanging, isDisabled) {
        var $v_0 = parseInt(this.getGlobalVariable('MaxSelectionsAllowed'), 10);
        var $v_1 = Microsoft.Crm.Client.Core.Models.Validation.IsRequiredValidator.prototype.validate.call(this, value, false, isDisabled);
        if (isValueChanging || isDisabled) {
            return $v_1;
        }
        if ($v_1.get_isValueValid()) {
            if (value && (value).length > $v_0) {
                var $v_2 = String.format(this.getLocalizedMessage('MultiSelectPicklistControl_MaxSelectionsError'), (value).length, $v_0);
                return new Microsoft.Crm.Client.Core.Models.Validation.ValidatorResult(false, value, $v_2);
            }
        }
        return $v_1;
    }
...
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapService = function(serverUri, authenticationManager, callerOriginProvider) {
    ...
    this.$x_1 = 0;
    this.$H_1 = this.$B_0 + '/XRMServices/2011/Organization.svc/web';
    this.$1I_1 = this.$B_0 + '/AppWebServices/ApplicationMetadataService.asmx/';
    this.$1w_1 = this.$B_0 + '/AppWebServices/MetadataService.asmx/';
    this.$l_1 = this.$B_0 + '/AppWebServices/ProcessControl.asmx/';
    this.$1L_1 = this.$B_0 + '/api/search/indexes/default/Entities';
    this.$1N_1 = this.$B_0 + '/Tools/Diagnostics/diag.aspx/GetMetrics';
    this.$1m_1 = this.$B_0 + '/AppWebServices/EmailTemplateService.asmx';
    this.$1h_1 = this.$B_0 + '/Handlers/GenerateAccessUrlHandler.ashx';
    this.$1n_1 = this.$B_0 + '/AppWebServices/CustomerService.asmx';
}
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapService.get_$2M = function() {
...
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapService.get_$2G = function() {
    return false;
}
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapService.prototype = {
    ...
    retrieveCustomControlManifest: function(customControlUniqueName) {
        var $v_0 = this.$1w_1 + 'GetCustomControlManifest';
        var $v_1 = JSON.stringify({ customControlUniqueName: customControlUniqueName });
        ...
        this.executeJsonRequest(Microsoft.Crm.Client.Core.Storage.WebService.WebServiceBase.RequestData.create($v_0, $v_1, this.createJsonRequestOptions($v_0), null)).then(function($p1_0) {
            var $v_3 = $p1_0['d'];
            if (_Script.isNullOrUndefined($p1_0) || _Script.isNullOrUndefined($v_3)) {
                var $v_4 = new Array(0);
                $v_4.push(new Microsoft.Crm.Client.Core.Framework.ErrorData(0, 'JSON response is null or undefined.'));
                $v_2.resolve(new Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.JsonResponses.JsonResponse(false, null, $v_4));
                return;
            }
            $v_2.resolve(new Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.JsonResponses.JsonResponse(true, $v_3, null));
        }, function($p1_0) {
            $v_2.reject($p1_0);
        });
        return $v_2.promise();
    ...
    execute: function(request, context, doAuthentication) {
        ...
        if (request.name === 'ScriptError') {
            $v_3 = this.$B_0 + '/AppWebServices/ScriptError.asmx';
    ...
    retrieveMetadataChanges: function(clientVersionStamp, languageCode) {
        var $v_0 = this.$2E_1(clientVersionStamp, null, languageCode);
    ...
    retrieveMetadataChangesByEntity: function(clientVersionStamp, entityLogicalNames, languageCode) {
        var $v_0 = this.$2E_1(clientVersionStamp, entityLogicalNames, languageCode);
        var $v_1 = Microsoft.Crm.Client.Core.Imported.MscrmComponents.deferredPromiseFactory(Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.Responses.RetrieveMetadataChangesResponse, Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.Responses.CrmErrorResponse);
        var $v_2 = this.createSoapRequestOptions(this.$H_1, 'http://schemas.microsoft.com/xrm/2011/Contracts/Services/IOrganizationService/Execute');
        $v_2.dataType = 'text';
        var $$t_8 = this, $$t_9 = this;
    ...
    retrieveMultipleEntityMetadata: function(languageCode, columnSet, entities, context) {
        ...
        if (_Script.isNullOrUndefined(columnSet) || Microsoft.Crm.Client.Core.Storage.Common.AllColumns.isInstanceOfType(columnSet)) {
            ...
            $v_0 = Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapService.get_$2M();
    ...
    retrieveMultipleAttributeMetadata: function(query, languageCode, context) {
        ...
        $v_0 += '<c:FilterOperator>Or</c:FilterOperator><c:Filters /></c:Criteria><c:Properties><c:AllProperties>false</c:AllProperties><c:PropertyNames xmlns:d=\"http://schemas.microsoft.com/2003/10/Serialization/Arrays\">' + Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapService.get_$20() + '</c:PropertyNames>' + '</c:Properties>' + '</c:AttributeQuery>' + '<c:LabelQuery>' + '<c:FilterLanguages xmlns:d=\"http://schemas.microsoft.com/2003/10/Serialization/Arrays\">' + '<d:int>' + languageCode + '</d:int>' + '</c:FilterLanguages>' + '<c:MissingLabelBehavior>1</c:MissingLabelBehavior>' + '</c:LabelQuery>' + '<c:RelationshipQuery i:nil=\"true\" />' + '</b:value>' + '</a:KeyValuePairOfstringanyType>';
    ...
    retrieveNavigationEntities: function(currentEntityId, referencedEntityLogicalName, referencingEntityLogicalName, referencingEntityAttributeName, context) {
        var $v_0 = this.$l_1 + 'GetForwardNavigationEntities';
    ...
    changeProcessAndStage: function(currentEntityId, currentEntityLogicalName, newProcessId, newProcessInstanceId, newStageId, newTraversalPath, context) {
        var $v_0 = this.$l_1 + 'ChangeProcessAndStageMoca';
    ...
    updateBusinessProcessFlowState: function(entityLogicalName, entityId, state, status, bpfInstanceId, context) {
        var $v_0 = this.$l_1 + 'UpdateBusinessProcessFlowState';
    ...
    createNavigationEntity: function(sourceEntityLogicalName, sourceEntityId, targetEntityLogicalName, targetEntityAttribute, context) {
        var $v_0 = this.$l_1 + 'CreateForwardNavigationEntity';
    ...
    retrieveMultipleProcessInstances: function(entityLogicalName, currentEntityId, context) {
        var $v_0 = this.$l_1 + 'RetrieveMultipleProcessInstances';
    ...
    $2E_1: function($p0, $p1, $p2) {
        ...
        $v_0 += '<c:Properties><c:AllProperties>false</c:AllProperties><c:PropertyNames xmlns:d=\"http://schemas.microsoft.com/2003/10/Serialization/Arrays\">' + $v_1 + '</c:PropertyNames>' + '</c:Properties>' + ((Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapService.get_$2G()) ? '' : '<c:AttributeQuery><c:Criteria><c:Conditions /><c:FilterOperator>And</c:FilterOperator><c:Filters /></c:Criteria><c:Properties><c:AllProperties>false</c:AllProperties><c:PropertyNames xmlns:d=\"http://schemas.microsoft.com/2003/10/Serialization/Arrays\">' + Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapService.get_$20() + '</c:PropertyNames>' + '</c:Properties>' + '</c:AttributeQuery>') + '<c:LabelQuery>' + '<c:FilterLanguages xmlns:d=\"http://schemas.microsoft.com/2003/10/Serialization/Arrays\">' + '<d:int>' + $p2 + '</d:int>' + '</c:FilterLanguages>' + '<c:MissingLabelBehavior>1</c:MissingLabelBehavior>' + '</c:LabelQuery>' + '<c:RelationshipQuery i:nil=\"true\" />' + '</b:value>' + '</a:KeyValuePairOfstringanyType>';
    ...
    createErrorResponse: function(request, textStatus, error) {
        return this.createErrorResponseWithSource(request, textStatus, error, '');
    },
    
    createErrorResponseWithSource: function(request, textStatus, error, source) {
        return new Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.Responses.CrmErrorResponse(request, textStatus, error, source);
    },
    ...
    handleServiceError: function(deferred, request, textStatus, error) {
        if (!_Script.isNullOrUndefined(request.responseText) && request.responseText.startsWith('{\"d\":{')) {
            ...
            deferred.reject(this.createErrorResponse(request, textStatus, error.toString()));
        }
    },
    ...
    resolveEmails: function(emails) {
        ...
        var $v_1 = this.$B_0 + '/AppWebServices/MailAppInitialDataService.asmx/' + 'ResolveRecipients';
...
Microsoft.Crm.Client.Core.Storage.DataApi.DataRetrievedEventArgs$1 = function(key, data, retrieveState, store, errorStatus, updateRecord) {
    ...
    this.$1x_2 = (_Script.isNullOrUndefined(updateRecord)) ? ((!store) ? false : true) : updateRecord;
}
...
Microsoft.Crm.Client.Core.Storage.DataApi.MetadataCache = function(dataSource) {
    this.$7_0 = dataSource;
    this.$8_0 = new (Microsoft.Crm.Client.Core.Framework.TypedDictionary$1.$$(Microsoft.Crm.Client.Core.Storage.Common.EntityAttributeMetadataPair))();
...
Microsoft.Crm.Client.Core.Storage.DataApi.MetadataCache.prototype = {
    ...
    getEntityMetadata: function(entityLogicalName) {
        if (this.$8_0.containsKey(entityLogicalName)) {
            return this.$8_0.get_item(entityLogicalName).get_entityMetadata();
        }
        return null;
    },
    ...
    cacheEntityMetadata: function(entityMetadata) {
        if (!_Script.isNullOrUndefined(entityMetadata)) {
            ...
            this.$8_0.set_item(entityMetadata.get_logicalName(), $v_0);
    ...
    cacheAttributeMetadata: function(entityLogicalName, allAttributes, attributeMetadata) {
        ...
        this.$8_0.get_item(entityLogicalName).get_attributeMetadataCollection().mergeAttributeMetadata(attributeMetadata.toArray(), allAttributes);
    },
    ...
    getMultipleAttributeMetadata: function(entityLogicalName, attributeNames) {
        ...
        var $v_0 = this.$8_0.get_item(entityLogicalName).get_attributeMetadataCollection();
    ...
    flushEntityMetadata: function(entityLogicalNames) {
        for (var $$arr_1 = entityLogicalNames, $$len_2 = $$arr_1.length, $$idx_3 = 0; $$idx_3 < $$len_2; ++$$idx_3) {
            var $v_0 = $$arr_1[$$idx_3];
            if (this.$8_0.containsKey($v_0)) {
                var $v_1 = this.$8_0.get_item($v_0).get_entityMetadata().get_objectTypeCode();
                var $v_2 = this.$8_0.get_item($v_0).get_entityMetadata().get_primaryIdAttribute();
                this.$8_0.remove($v_0);
    ...
    flushAllAttributeMetadata: function() {
        var $$dict_1 = this.$8_0.toDictionary();
        for (var $$key_2 in $$dict_1) {
            var $v_0 = { key: $$key_2, value: $$dict_1[$$key_2] };
    ...
    getAttributeMetadataCacheCount: function(entityLogicalName) {
        ...
        return this.$8_0.get_item(entityLogicalName).get_attributeMetadataCollection().get_count();
    }
}


Microsoft.Crm.Client.Core.Storage.DataApi.DataSource = function(userContext) {
    this.$C_0 = userContext;
...
Microsoft.Crm.Client.Core.Storage.DataApi.DataSource.initialize = function() {
    ...
    $v_1 = $v_1 && !_Script.isNullOrUndefined(Microsoft.Crm.Client.Core.Storage.DataApi.DataSource.$4.$C_0);
...
Microsoft.Crm.Client.Core.Storage.DataApi.DataSource.$2l = function($p0) {
...
Microsoft.Crm.Client.Core.Storage.DataApi.DataSource.prototype = {
    ...
    retrieveMultipleAttributeMetadata: function(query, context) {
        ...
        Xrm.Internal.messages.retrieveMultipleAttributeMetadata($v_5, this.$C_0.get_UserSettings().get_languageId()).then(function($p1_0) {
            ...
            $v_0.reject(Microsoft.Crm.Client.Core.Storage.DataApi.DataSource.$2l($p1_0));
        });
        return $v_0.promise();
    },
    ...
    retrieveRecordRelatedEntities: function(entityMetadata, source, identifier, columnSet, record) {
        ...
        this.$2X_0(entityMetadata, columnSet, null, function($p1_0) {
            if (Microsoft.Crm.Client.Core.Storage.Common.ObjectModel.EntityMetadata.hasAccessRights(identifier.LogicalName, $$t_A.$I_0)) {
                $v_1.push(new Xrm.Gen.RetrievePrincipalAccessRequest(identifier, new Xrm.Objects.EntityReference('systemuser', Microsoft.Crm.Client.Core.Storage.DataApi.DataSource.$4.$C_0.get_userId())));
            }
            if (!$p1_0) {
    ...
    $2X_0: function($p0, $p1, $p2, $p3) {
        if ($p0.get_hasSecuredAttributes()) {
            ...
            if (_Script.isNullOrUndefined($v_1) || $v_1.length !== $v_0.length) {
                ...
                $p3(this.$22_0(new (Microsoft.Crm.Client.Core.Framework.CallbackSafeArray$1.$$(Microsoft.Crm.Client.Core.Storage.Common.IAttributeMetadata))($v_1)));
            }
        }
        else {
            $p3(true);
    ...
    $22_0: function($p0) {
        ...
        for (var $v_1 = 0; $v_1 < $p0.get_length(); $v_1++) {
            if ($p0.get_item($v_1).get_isSecured()) {
                var $v_2 = Microsoft.Crm.Client.Core.Storage.DataApi.DataSource.$4.$C_0.get_attributePrivileges().get_item($p0.get_item($v_1).get_id().toString());
    ...
    retrieveCustomControlManifest: function(customControlUniqueName) {
        return Xrm.Internal.messages.retrieveCustomControlManifest(customControlUniqueName);
    },
...
Microsoft.Crm.Client.Core.Models.Formatters.EntityFormFieldFormatter.prototype = {
    ...
    formatDateTimeFieldValue: function(fieldName, rawValue) {
        ...
        if (Microsoft.Crm.Client.Core.Storage.Common.CrmFormatter.isDateTime(rawValue) && ((fieldName) in $v_0.$n_2)) {
            var $v_6 = $v_0.$n_2[fieldName];
...
Microsoft.Crm.Client.Core.Models.Formatters.FormFieldFormatter.prototype = {
    ...
    formatFieldValue: function(fieldAttributeType, fieldName, rawValue, metadata) {
        ...
        if (Microsoft.Crm.Client.Core.Framework.IPicklistItem.isInstanceOfType(rawValue)) {
            ...
            switch (fieldAttributeType) {
                case 18:
                case 5:
                    return this.$29_0(fieldName, rawValue);
                case 4:
                case 3:
                ...
                case 14:
                    return this.$2i_0(fieldName, rawValue);
                case 24:
                    return this.$2h_0(rawValue, metadata);
                default:
                    return null;
            }
        }
    ...
    $2h_0: function($p0, $p1) {
        if (!_Script.isNullOrUndefined($p0) && ($p0).length > 0 && !_Script.isNullOrUndefined($p1)) {
            var $v_0 = $p0;
            var $v_1 = '';
            var $v_2 = $p1.get_optionSet();
            for (var $v_3 = 0; $v_3 < $v_0.length; $v_3++) {
                if (!_Script.isNullOrUndefined($v_0[$v_3])) {
                    var $v_4 = $v_2.get_options()[$v_0[$v_3].toString()];
                    if (!_Script.isNullOrUndefined($v_4)) {
                        $v_1 += $v_4.get_label() + '; ';
                    }
                }
            }
            return ($v_1 === '') ? null : $v_1.slice(0, -2);
        }
        return null;
    },
    
    $2s_0: function() {
        return Microsoft.Crm.Client.Core.Storage.DataApi.DataSource.$4.$C_0.getTransactionCurrencySymbol(this.$9_0.get_transactionCurrencyId());
    }
}
            ...
            if ($v_X.namespaceURI === 'http://schemas.microsoft.com/xrm/2011/Metadata') {
                ...
                switch ($v_Y) {
                    ...
                    case 'AttributeTypeName':
                        $v_4 = Xrm.Soap.AttributeMetadataSerializer.$34($v_X.childNodes[0].firstChild.nodeValue);
                        break;
                    case 'RequiredLevel':
...
Xrm.Soap.BusinessNotificationArraySerializer.loadFromCrmSoap = function(xml) {
    ...
    if ($v_1) {
        for (var $v_2 = 0; $v_2 < $v_1.get_count(); $v_2++) {
            ...
            $v_0[$v_0.length] = Xrm.Soap.BusinessNotificationSerializer.loadFromCrmSoap($v_3);
        }
    }
    return $v_0;
}
...
Xrm.Soap.CrmDateTimeSerializer.get_$2U = function() {
    return Xrm.Soap.CrmDateTimeSerializer.$1z || (Xrm.Soap.CrmDateTimeSerializer.$1z = new RegExp('[Z,T]', 'ig'));
}
...
Xrm.Soap.EntityMetadataCollectionSerializer.$37 = function($p0, $p1) {
    ...
    if ($v_g) {
        $v_U = Xrm.Soap.EntityMetadataCollectionSerializer.$25($v_g, 'activitypointer', 'regardingobjectid');
        $v_c = Xrm.Soap.EntityMetadataCollectionSerializer.$25($v_g, 'annotation', 'objectid');
    }
...
Xrm.Soap.EntityMetadataCollectionSerializer.$25 = function($p0, $p1, $p2) {
    for (var $v_0 = 0, $v_1 = $p0.childNodes.length; $v_0 < $v_1; $v_0++) {
        var $v_2 = $p0.childNodes[$v_0];
...
Xrm.Soap.EntityRecordSerializer.fieldToCrmSoap = function(fieldName, value, fieldType, fieldTypeName, namespaceDeclaration) {
    ...
    if (_Script.isNullOrUndefined(namespaceDeclaration)) {
        namespaceDeclaration = Xrm.Soap.EntityRecordSerializer.$2n(fieldType);
    }
            ...
            case 24:
                if (!_Script.isNullOrUndefined(value)) {
                    ...
                    for (var $v_4 = 0; $v_4 < $v_3.length; $v_4++) {
                        $v_0 += '<c:OptionSetValue><a:Value>';
                        $v_0 += $v_3[$v_4];
                        $v_0 += '</a:Value></c:OptionSetValue>';
                    }
                }
                break;
            case 15:
...
Xrm.Soap.EntityRecordSerializer.$38 = function($p0, $p1, $p2) {
    for (var $v_0 = 0, $v_1 = $p0.childNodes.length; $v_0 < $v_1; $v_0++) {
        ...
        if ($v_2.namespaceURI === 'http://schemas.microsoft.com/xrm/2011/Contracts' && Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.SerializerUtility.$3($v_2.nodeName) === 'KeyValuePairOfstringanyType') {
            ...
            if (Xrm.Soap.EntityRecordSerializer.$2H($v_4, $v_5)) {
                continue;
            }
            ...
            if ($v_6 !== -1) {
                ...
                switch ($v_6) {
                    ...
                    case 0:
                        ...
                        break;
                    case 8:
                        $v_I = parseFloat(Xrm.Soap.EntityRecordSerializer.$2F($v_4));
                        break;
                    case 3:
                    case 4:
                        if (!_Script.isNullOrUndefined($v_4.firstChild) && !Microsoft.Crm.Client.Core.Framework._String.isNullOrEmpty($v_4.firstChild.nodeValue)) {
                    ...
                    case 12:
                    case 11:
                        $v_I = new Microsoft.Crm.Client.Core.Storage.Common.ObjectModel.OptionMetadata(null, parseInt(Xrm.Soap.EntityRecordSerializer.$2F($v_4)), -1, -1, null, null, null);
                        break;
                    case 24:
                        $v_I = Xrm.Soap.EntityRecordSerializer.$2z($v_4);
                        break;
                    default:
...
Xrm.Soap.EntityRecordSerializer.$2e = function($p0) {
    switch ($p0) {
        ...
        case 24:
            return 'c:OptionSetValueCollection';
        case 18:
            return 'a:long';
        default:
...
Xrm.Soap.EntityRecordSerializer.$2n = function($p0) {
    switch ($p0) {
        case 14:
        case 2:
        case 3:
        ...
        case 24:
            return 'xmlns:c=\"http://schemas.microsoft.com/xrm/9.0/Contracts\"';
        default:
            return '';
    }
}
Xrm.Soap.EntityRecordSerializer.$2H = function($p0, $p1) {
    if (Microsoft.Crm.Client.Core.Framework._String.isNullOrEmpty($p1)) {
        return $p0.getAttribute('i:nil') === 'true';
    }
    return false;
}
Xrm.Soap.EntityRecordSerializer.$2F = function($p0) {
    var $v_0 = null;
...
Xrm.Soap.EntityRecordSerializer.$2z = function($p0) {
    var $v_0 = new (Microsoft.Crm.Client.Core.Framework.List$1.$$(Number))();
    if (!_Script.isNullOrUndefined($p0)) {
        for (var $v_1 = 0, $v_2 = $p0.childNodes.length; $v_1 < $v_2; $v_1++) {
            if (!_Script.isNullOrUndefined($p0.childNodes[$v_1])) {
                $v_0.add(parseInt($p0.childNodes[$v_1].firstChild.firstChild.nodeValue));
            }
        }
    }
    return $v_0.toArray();
    ...
    for (var $v_1 = 0, $v_2 = $p0.childNodes.length; $v_1 < $v_2; $v_1++) {
        ...
        if ($v_3.namespaceURI === 'http://schemas.microsoft.com/xrm/2011/Metadata' && Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.SerializerUtility.$3($v_3.nodeName) === 'Options') {
            for (var $v_4 = 0, $v_5 = $v_3.childNodes.length; $v_4 < $v_5; $v_4++) {
                $v_0 = Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.OptionSetMetadataSerializer.$2J($v_0, $v_3, $v_3.childNodes[$v_4], $v_4);
            }
        }
            ...
            $v_0 = Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.OptionSetMetadataSerializer.$2J($v_0, $v_3, $v_3, $v_1);
        }
    }
    return new Microsoft.Crm.Client.Core.Storage.Common.ObjectModel.OptionSetMetadata($v_0);
}
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.OptionSetMetadataSerializer.$2J = function($p0, $p1, $p2, $p3) {
    var $v_0 = -1;
    var $v_1 = null;
    var $v_2 = -1;
    var $v_3 = -1;
...
Xrm.Soap.Parser.load = function(T, data, key, serializedType) {
    if (_Script.isNullOrUndefined(serializedType)) {
        serializedType = Xrm.Soap.Parser.$2q(T);
    }
    ...
    if (!$v_3) {
        ...
        if (serializedType === 'EntityReference') {
            $v_2 = (!_Script.isNullOrUndefined($v_2) && Microsoft.Crm.Client.Core.Framework._String.isNullOrEmpty(Xrm.Soap.Parser.$2p(data, key))) ? null : $v_2;
        }
    }
    return $v_2;
}
...
Xrm.Soap.Parser.$2p = function($p0, $p1) {
...
Xrm.Soap.Parser.parseEntityCollection = function(data, key) {
    ...
    return (_Script.isNullOrUndefined($v_0)) ? null : Xrm.Soap.EntityCollectionSerializer.loadFromCrmSoap($v_0, Microsoft.Crm.Client.Core.Storage.DataApi.Query.get_empty());
}
...
Xrm.Soap.Parser.parseBusinessNotificationArray = function(data, key) {
    data.addNamespace('b', 'http://schemas.datacontract.org/2004/07/System.Collections.Generic');
    var $v_0 = Xrm.Soap.Parser.$M(data, key);
...
Xrm.Soap.Serializer.loadFromCrmSoap = function(data) {
    var $v_0 = null;
    if ((($v_0) in Xrm.Soap.Serializer.$o)) {
        return (Xrm.Soap.Serializer.$o[$v_0])(data);
    }
    else {
...
Xrm.Soap.Serializer.loadFromCrmSoapByName = function(data, name) {
    if (((name) in Xrm.Soap.Serializer.$o)) {
        return (Xrm.Soap.Serializer.$o[name])(data);
    }
    else {
...
Xrm.Soap.Serializer.registerDeserializer = function(name, deserializer) {
    Xrm.Soap.Serializer.$o[name] = deserializer;
}
...
Xrm.Soap.ValidationResultSerializer.loadFromCrmSoap = function(xml) {
    ...
    if (xml) {
        xml.addNamespace('b', 'http://schemas.microsoft.com/crm/2011/Contracts');
        xml.addNamespace('c', 'http://schemas.datacontract.org/2004/07/System.Collections.Generic');
        var $v_3 = xml.selectSingleNode('b:ActivityId');
        if ($v_3) {
            $v_2 = new Microsoft.Crm.Client.Core.Framework.Guid($v_3.get_innerText());
        }
        ...
        if ($v_5) {
            $v_1 = Xrm.Soap.TraceInfoSerializer.loadFromCrmSoap($v_5);
        }
    }
...
Xrm.Gen.DismissExchangeEnhancedActionCardsRequestSerializer = function() {
}
Xrm.Gen.DismissExchangeEnhancedActionCardsRequestSerializer.parametersToCrmSoap = function(request) {
    return Xrm.Soap.Write.f('MessageId', (request).messageId, 14) + Xrm.Soap.Write.f('CardType', (request).cardType, 5);
}
Xrm.Gen.DismissExchangeEnhancedActionCardsRequestSerializer.loadFromCrmSoap = function(data) {
    if (_Script.isNullOrUndefined(data)) {
        return null;
    }
    return new Xrm.Gen.DismissExchangeEnhancedActionCardsRequest(Xrm.Soap.Parser.load(String, data, 'MessageId'), Xrm.Soap.Parser.load(Number, data, 'CardType'));
}
...
Xrm.Gen.BestTimeToEmailResponseSerializer.loadFromCrmSoap = function(soapResponse, request) {
    return Xrm.Soap.ResponseSerializer.deserialize(soapResponse, request, function($p1_0) {
        return new Xrm.Gen.BestTimeToEmailResponse(Xrm.Soap.Parser.load(Date, $p1_0, 'PreferredTime'), Xrm.Soap.Parser.load(String, $p1_0, 'WeekDayStart'), Xrm.Soap.Parser.load(String, $p1_0, 'WeekDayEnd'), Xrm.Soap.Parser.load(Number, $p1_0, 'ShouldDisplay'));
    });
}
...
Xrm.Gen.IsLegacyCustomerRequestSerializer = function() {
}
Xrm.Gen.IsLegacyCustomerRequestSerializer.parametersToCrmSoap = function(request) {
    return null;
}
Xrm.Gen.IsLegacyCustomerRequestSerializer.loadFromCrmSoap = function(data) {
    if (_Script.isNullOrUndefined(data)) {
        return null;
    }
    return new Xrm.Gen.IsLegacyCustomerRequest();
}


Xrm.Gen.IsLegacyCustomerResponseSerializer = function() {
}
Xrm.Gen.IsLegacyCustomerResponseSerializer.loadFromCrmSoap = function(soapResponse, request) {
    return Xrm.Soap.ResponseSerializer.deserialize(soapResponse, request, function($p1_0) {
        return new Xrm.Gen.IsLegacyCustomerResponse(Xrm.Soap.Parser.load(Boolean, $p1_0, 'IsLegacyCustomer'));
    });
}


Xrm.Gen.GetAciMarsConnectorStatusRequestSerializer = function() {
}
Xrm.Gen.GetAciMarsConnectorStatusRequestSerializer.parametersToCrmSoap = function(request) {
    return null;
}
Xrm.Gen.GetAciMarsConnectorStatusRequestSerializer.loadFromCrmSoap = function(data) {
    if (_Script.isNullOrUndefined(data)) {
        return null;
    }
    return new Xrm.Gen.GetAciMarsConnectorStatusRequest();
}


Xrm.Gen.GetAciMarsConnectorStatusResponseSerializer = function() {
}
Xrm.Gen.GetAciMarsConnectorStatusResponseSerializer.loadFromCrmSoap = function(soapResponse, request) {
    return Xrm.Soap.ResponseSerializer.deserialize(soapResponse, request, function($p1_0) {
        return new Xrm.Gen.GetAciMarsConnectorStatusResponse(Xrm.Soap.Parser.load(String, $p1_0, 'AciMarsConnectorStatus'));
    });
}
...
Xrm.Gen.SnoozeExchangeActionCardsRequestSerializer = function() {
}
Xrm.Gen.SnoozeExchangeActionCardsRequestSerializer.parametersToCrmSoap = function(request) {
    return Xrm.Soap.Write.f('MessageId', (request).messageId, 14) + Xrm.Soap.Write.f('CardType', (request).cardType, 5);
}
Xrm.Gen.SnoozeExchangeActionCardsRequestSerializer.loadFromCrmSoap = function(data) {
    if (_Script.isNullOrUndefined(data)) {
        return null;
    }
    return new Xrm.Gen.SnoozeExchangeActionCardsRequest(Xrm.Soap.Parser.load(String, data, 'MessageId'), Xrm.Soap.Parser.load(Number, data, 'CardType'));
}
...
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated.AssociateKnowledgeArticleRequestSerializer.loadFromCrmSoap = function(data) {
    ...
    var $v_8 = data.selectSingleNode('.//a:KeyValuePairOfstringanyType[b:key=\'EntityName\']/b:value');
    var $v_9 = (!_Script.isNullOrUndefined($v_8)) ? $v_8.get_innerText() : null;
    return new Xrm.Sdk.AssociateKnowledgeArticleRequest($v_1, $v_3, $v_5, $v_7, $v_9);
}
...
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated.DisassociateKnowledgeArticleRequestSerializer.loadFromCrmSoap = function(data) {
    ...
    var $v_8 = data.selectSingleNode('.//a:KeyValuePairOfstringanyType[b:key=\'EntityName\']/b:value');
    var $v_9 = (!_Script.isNullOrUndefined($v_8)) ? $v_8.get_innerText() : null;
    return new Xrm.Sdk.DisassociateKnowledgeArticleRequest($v_1, $v_3, $v_5, $v_7, $v_9);
}
...
Xrm.Gen.CheckInDocumentRequestSerializer.parametersToCrmSoap = function(request) {
    return Xrm.Soap.Write.f('Entity', (request).entity, -1, 'a:Entity') + Xrm.Soap.Write.f('CheckInComments', (request).checkInComments, 14) + Xrm.Soap.Write.f('RetainCheckout', (request).retainCheckout, 0) + Xrm.Soap.Write.f('ParentEntityReference', (request).parentEntityReference, 6);
}
Xrm.Gen.CheckInDocumentRequestSerializer.loadFromCrmSoap = function(data) {
    if (_Script.isNullOrUndefined(data)) {
        return null;
    }
    return new Xrm.Gen.CheckInDocumentRequest(Xrm.Soap.Parser.load(Microsoft.Crm.Client.Core.Storage.Common.ObjectModel.EntityRecord, data, 'Entity'), Xrm.Soap.Parser.load(String, data, 'CheckInComments'), Xrm.Soap.Parser.load(Boolean, data, 'RetainCheckout'), Xrm.Soap.Parser.load(Xrm.Objects.EntityReference, data, 'ParentEntityReference'));
}
...
Xrm.Gen.CheckoutDocumentRequestSerializer.parametersToCrmSoap = function(request) {
    return Xrm.Soap.Write.f('Entity', (request).entity, -1, 'a:Entity') + Xrm.Soap.Write.f('ParentEntityReference', (request).parentEntityReference, 6);
}
Xrm.Gen.CheckoutDocumentRequestSerializer.loadFromCrmSoap = function(data) {
    if (_Script.isNullOrUndefined(data)) {
        return null;
    }
    return new Xrm.Gen.CheckoutDocumentRequest(Xrm.Soap.Parser.load(Microsoft.Crm.Client.Core.Storage.Common.ObjectModel.EntityRecord, data, 'Entity'), Xrm.Soap.Parser.load(Xrm.Objects.EntityReference, data, 'ParentEntityReference'));
}
...
Xrm.Gen.NewDocumentRequestSerializer.parametersToCrmSoap = function(request) {
    return Xrm.Soap.Write.f('FileName', (request).fileName, 14) + Xrm.Soap.Write.f('LocationId', (request).locationId, 14) + Xrm.Soap.Write.f('ParentEntityReference', (request).parentEntityReference, 6) + Xrm.Soap.Write.f('IsFolder', (request).isFolder, 0) + Xrm.Soap.Write.f('FolderPath', (request).folderPath, 14);
}
Xrm.Gen.NewDocumentRequestSerializer.loadFromCrmSoap = function(data) {
    if (_Script.isNullOrUndefined(data)) {
        return null;
    }
    return new Xrm.Gen.NewDocumentRequest(Xrm.Soap.Parser.load(String, data, 'FileName'), Xrm.Soap.Parser.load(String, data, 'LocationId'), Xrm.Soap.Parser.load(Xrm.Objects.EntityReference, data, 'ParentEntityReference'), Xrm.Soap.Parser.load(Boolean, data, 'IsFolder'), Xrm.Soap.Parser.load(String, data, 'FolderPath'));
}
...
Xrm.Gen.CreateFolderRequestSerializer.parametersToCrmSoap = function(request) {
    return Xrm.Soap.Write.f('FolderName', (request).folderName, 14) + Xrm.Soap.Write.f('ParentEntityReference', (request).parentEntityReference, 6) + Xrm.Soap.Write.f('DocumentType', (request).documentType, 5) + Xrm.Soap.Write.f('ParentLocationId', (request).parentLocationId, 14) + Xrm.Soap.Write.f('SiteType', (request).siteType, 5) + Xrm.Soap.Write.f('ValidateFolder', (request).validateFolder, 0);
}
Xrm.Gen.CreateFolderRequestSerializer.loadFromCrmSoap = function(data) {
    if (_Script.isNullOrUndefined(data)) {
        return null;
    }
    return new Xrm.Gen.CreateFolderRequest(Xrm.Soap.Parser.load(String, data, 'FolderName'), Xrm.Soap.Parser.load(Xrm.Objects.EntityReference, data, 'ParentEntityReference'), Xrm.Soap.Parser.load(Number, data, 'DocumentType'), Xrm.Soap.Parser.load(String, data, 'ParentLocationId'), Xrm.Soap.Parser.load(Number, data, 'SiteType'), Xrm.Soap.Parser.load(Boolean, data, 'ValidateFolder'));
}
...
Xrm.Gen.SearchDocumentRequestSerializer.parametersToCrmSoap = function(request) {
    return Xrm.Soap.Write.f('DocumentId', (request).documentId, 14) + Xrm.Soap.Write.f('ParentEntityReference', (request).parentEntityReference, 6);
}
Xrm.Gen.SearchDocumentRequestSerializer.loadFromCrmSoap = function(data) {
    if (_Script.isNullOrUndefined(data)) {
        return null;
    }
    return new Xrm.Gen.SearchDocumentRequest(Xrm.Soap.Parser.load(String, data, 'DocumentId'), Xrm.Soap.Parser.load(Xrm.Objects.EntityReference, data, 'ParentEntityReference'));
}
...
Xrm.Gen.SubmitImportedDataRequestSerializer = function() {
}
Xrm.Gen.SubmitImportedDataRequestSerializer.parametersToCrmSoap = function(request) {
    return Xrm.Soap.Write.f('ImportWizardData', (request).importWizardData, 14);
}
Xrm.Gen.SubmitImportedDataRequestSerializer.loadFromCrmSoap = function(data) {
    if (_Script.isNullOrUndefined(data)) {
        return null;
    }
    return new Xrm.Gen.SubmitImportedDataRequest(Xrm.Soap.Parser.load(String, data, 'ImportWizardData'));
}


Xrm.Gen.SubmitImportedDataResponseSerializer = function() {
}
Xrm.Gen.SubmitImportedDataResponseSerializer.loadFromCrmSoap = function(soapResponse, request) {
    return Xrm.Soap.ResponseSerializer.deserialize(soapResponse, request, function($p1_0) {
        return new Xrm.Gen.SubmitImportedDataResponse(Xrm.Soap.Parser.load(String, $p1_0, 'ImportStatus'));
    });
}
...
Xrm.Gen.CreateFolderAndNewDocumentsRequestSerializer = function() {
}
Xrm.Gen.CreateFolderAndNewDocumentsRequestSerializer.parametersToCrmSoap = function(request) {
    return Xrm.Soap.Write.f('FolderName', (request).folderName, 14) + Xrm.Soap.Write.f('FileNameList', (request).fileNameList, -1, 'a:StringArray') + Xrm.Soap.Write.f('LocationType', (request).locationType, 5) + Xrm.Soap.Write.f('ParentEntityReference', (request).parentEntityReference, 6) + Xrm.Soap.Write.f('ParentLocationId', (request).parentLocationId, 14);
}
Xrm.Gen.CreateFolderAndNewDocumentsRequestSerializer.loadFromCrmSoap = function(data) {
    if (_Script.isNullOrUndefined(data)) {
        return null;
    }
    return new Xrm.Gen.CreateFolderAndNewDocumentsRequest(Xrm.Soap.Parser.load(String, data, 'FolderName'), Xrm.Soap.Parser.load(Array, data, 'FileNameList', 'StringArray'), Xrm.Soap.Parser.load(Number, data, 'LocationType'), Xrm.Soap.Parser.load(Xrm.Objects.EntityReference, data, 'ParentEntityReference'), Xrm.Soap.Parser.load(String, data, 'ParentLocationId'));
}


Xrm.Gen.CreateFolderAndNewDocumentsResponseSerializer = function() {
}
Xrm.Gen.CreateFolderAndNewDocumentsResponseSerializer.loadFromCrmSoap = function(soapResponse, request) {
    return Xrm.Soap.ResponseSerializer.deserialize(soapResponse, request, function($p1_0) {
        return new Xrm.Gen.CreateFolderAndNewDocumentsResponse(Xrm.Soap.Parser.load(Microsoft.Crm.Client.Core.Framework.Guid, $p1_0, 'LocationId'));
    });
}
...
Xrm.Gen.RetrieveActiveStageRecordRequestSerializer = function() {
}
Xrm.Gen.RetrieveActiveStageRecordRequestSerializer.parametersToCrmSoap = function(request) {
    return Xrm.Soap.Write.f('BpfEntityReference', (request).bpfEntityReference, 6);
}
Xrm.Gen.RetrieveActiveStageRecordRequestSerializer.loadFromCrmSoap = function(data) {
    if (_Script.isNullOrUndefined(data)) {
        return null;
    }
    return new Xrm.Gen.RetrieveActiveStageRecordRequest(Xrm.Soap.Parser.load(Xrm.Objects.EntityReference, data, 'BpfEntityReference'));
}


Xrm.Gen.RetrieveActiveStageRecordResponseSerializer = function() {
}
Xrm.Gen.RetrieveActiveStageRecordResponseSerializer.loadFromCrmSoap = function(soapResponse, request) {
    return Xrm.Soap.ResponseSerializer.deserialize(soapResponse, request, function($p1_0) {
        return new Xrm.Gen.RetrieveActiveStageRecordResponse(Xrm.Soap.Parser.load(Microsoft.Crm.Client.Core.Storage.Common.ObjectModel.EntityRecord, $p1_0, 'Entity'));
    });
}
...
Xrm.Gen.UploadDocumentRequestSerializer = function() {
}
Xrm.Gen.UploadDocumentRequestSerializer.parametersToCrmSoap = function(request) {
    return Xrm.Soap.Write.f('Content', (request).content, -1, 'a:ByteArray') + Xrm.Soap.Write.f('Entity', (request).entity, -1, 'a:Entity') + Xrm.Soap.Write.f('OverwriteExisting', (request).overwriteExisting, 0) + Xrm.Soap.Write.f('ParentEntityReference', (request).parentEntityReference, 6) + Xrm.Soap.Write.f('FolderPath', (request).folderPath, 14);
}
Xrm.Gen.UploadDocumentRequestSerializer.loadFromCrmSoap = function(data) {
    if (_Script.isNullOrUndefined(data)) {
        return null;
    }
    return new Xrm.Gen.UploadDocumentRequest(Xrm.Soap.Parser.load(String, data, 'Content', 'ByteArray'), Xrm.Soap.Parser.load(Microsoft.Crm.Client.Core.Storage.Common.ObjectModel.EntityRecord, data, 'Entity'), Xrm.Soap.Parser.load(Boolean, data, 'OverwriteExisting'), Xrm.Soap.Parser.load(Xrm.Objects.EntityReference, data, 'ParentEntityReference'), Xrm.Soap.Parser.load(String, data, 'FolderPath'));
}
...
Xrm.Gen.DeleteDocumentRequestSerializer.parametersToCrmSoap = function(request) {
    return Xrm.Soap.Write.f('Entities', (request).entities, -1, 'a:EntityCollection') + Xrm.Soap.Write.f('ParentEntityReference', (request).parentEntityReference, 6);
}
Xrm.Gen.DeleteDocumentRequestSerializer.loadFromCrmSoap = function(data) {
    if (_Script.isNullOrUndefined(data)) {
        return null;
    }
    return new Xrm.Gen.DeleteDocumentRequest(Xrm.Soap.Parser.load(Microsoft.Crm.Client.Core.Storage.Common.ObjectModel.EntityCollection, data, 'Entities'), Xrm.Soap.Parser.load(Xrm.Objects.EntityReference, data, 'ParentEntityReference'));
}
...
Xrm.Gen.DiscardDocumentCheckoutRequestSerializer.loadFromCrmSoap = function(data) {
    ...
    return new Xrm.Gen.DiscardDocumentCheckoutRequest(Xrm.Soap.Parser.load(Microsoft.Crm.Client.Core.Storage.Common.ObjectModel.EntityRecord, data, 'Entity'), Xrm.Soap.Parser.load(Xrm.Objects.EntityReference, data, 'ParentEntityReference'));
}
...
Xrm.Gen.EditDocumentPropertiesRequestSerializer.loadFromCrmSoap = function(data) {
    ...
    return new Xrm.Gen.EditDocumentPropertiesRequest(Xrm.Soap.Parser.load(Microsoft.Crm.Client.Core.Storage.Common.ObjectModel.EntityRecord, data, 'Entity'), Xrm.Soap.Parser.load(Xrm.Objects.EntityReference, data, 'ParentEntityReference'));
}
...
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated.ExecuteQuickFindRequestSerializer.parametersToCrmSoap = function(request) {
    var $v_0 = request;
    return Xrm.Soap.EntityRecordSerializer.fieldToCrmSoap('SearchText', $v_0.searchText, 14) + Xrm.Soap.EntityRecordSerializer.fieldToCrmSoap('EntityGroupName', $v_0.entityGroupName, 14) + Xrm.Soap.EntityRecordSerializer.fieldToCrmSoap('EntityNames', $v_0.entityNames, -1, 'sa:ArrayOfstring', 'xmlns:sa=\"http://schemas.microsoft.com/2003/10/Serialization/Arrays\"') + Xrm.Soap.EntityRecordSerializer.fieldToCrmSoap('AppModule', $v_0.appModule, 6);
}
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated.ExecuteQuickFindRequestSerializer.loadFromCrmSoap = function(data) {
    ...
    return new Xrm.Sdk.ExecuteQuickFindRequest($v_1, $v_3, $v_5, Xrm.Soap.Parser.load(Xrm.Objects.EntityReference, data, 'AppModule'));
}
...
Xrm.Gen.GetValidStatusTransitionRequestSerializer.parametersToCrmSoap = function(request) {
    return Xrm.Soap.Write.f('IncidentId', (request).incidentId, 15) + Xrm.Soap.Write.f('ToStateCode', (request).toStateCode, 5);
}
Xrm.Gen.GetValidStatusTransitionRequestSerializer.loadFromCrmSoap = function(data) {
    if (_Script.isNullOrUndefined(data)) {
        return null;
    }
    return new Xrm.Gen.GetValidStatusTransitionRequest(Xrm.Soap.Parser.load(Microsoft.Crm.Client.Core.Framework.Guid, data, 'IncidentId'), Xrm.Soap.Parser.load(Number, data, 'ToStateCode'));
}
...
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated.SetDelaySendForEmailRequestSerializer = function() {
}
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated.SetDelaySendForEmailRequestSerializer.$$cctor = function() {
    Xrm.Soap.Serializer.registerSerializer('SetDelaySendForEmail', Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated.SetDelaySendForEmailRequestSerializer.parametersToCrmSoap);
    Xrm.Soap.Serializer.registerDeserializer('SetDelaySendForEmail', Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated.SetDelaySendForEmailRequestSerializer.loadFromCrmSoap);
}
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated.SetDelaySendForEmailRequestSerializer.parametersToCrmSoap = function(request) {
    var $v_0 = request;
    return Xrm.Soap.EntityRecordSerializer.fieldToCrmSoap('EmailId', $v_0.emailId, 15) + Xrm.Soap.EntityRecordSerializer.fieldToCrmSoap('DelayTime', $v_0.delayTime, 2);
}
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated.SetDelaySendForEmailRequestSerializer.loadFromCrmSoap = function(data) {
    if (_Script.isNullOrUndefined(data)) {
        return null;
    }
    var $v_0 = data.selectSingleNode('.//a:KeyValuePairOfstringanyType[b:key=\'EmailId\']/b:value');
    var $v_1 = (!_Script.isNullOrUndefined($v_0)) ? new Microsoft.Crm.Client.Core.Framework.Guid($v_0.get_innerText()) : null;
    var $v_2 = data.selectSingleNode('.//a:KeyValuePairOfstringanyType[b:key=\'DelayTime\']/b:value');
    var $v_3;
    if (!_Script.isNullOrUndefined($v_2)) {
        $v_3 = Xrm.Soap.CrmDateTimeSerializer.loadFromCrmSoap($v_2.get_domParserElement());
    }
    else {
        throw Error.notImplemented();
    }
    return new Xrm.Gen.SetDelaySendForEmailRequest($v_1, $v_3);
}


Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated.SetReminderForEmailRequestSerializer = function() {
}
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated.SetReminderForEmailRequestSerializer.$$cctor = function() {
    Xrm.Soap.Serializer.registerSerializer('SetReminderForEmail', Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated.SetReminderForEmailRequestSerializer.parametersToCrmSoap);
    Xrm.Soap.Serializer.registerDeserializer('SetReminderForEmail', Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated.SetReminderForEmailRequestSerializer.loadFromCrmSoap);
}
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated.SetReminderForEmailRequestSerializer.parametersToCrmSoap = function(request) {
    var $v_0 = request;
    return Xrm.Soap.EntityRecordSerializer.fieldToCrmSoap('EmailId', $v_0.emailId, 15) + Xrm.Soap.EntityRecordSerializer.fieldToCrmSoap('ReminderTime', $v_0.reminderTime, 2) + Xrm.Soap.EntityRecordSerializer.fieldToCrmSoap('ReminderType', $v_0.reminderType, 11) + Xrm.Soap.EntityRecordSerializer.fieldToCrmSoap('ReminderText', $v_0.reminderText, 14);
}
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated.SetReminderForEmailRequestSerializer.loadFromCrmSoap = function(data) {
    if (_Script.isNullOrUndefined(data)) {
        return null;
    }
    var $v_0 = data.selectSingleNode('.//a:KeyValuePairOfstringanyType[b:key=\'EmailId\']/b:value');
    var $v_1 = (!_Script.isNullOrUndefined($v_0)) ? new Microsoft.Crm.Client.Core.Framework.Guid($v_0.get_innerText()) : null;
    var $v_2 = data.selectSingleNode('.//a:KeyValuePairOfstringanyType[b:key=\'ReminderTime\']/b:value');
    var $v_3;
    if (!_Script.isNullOrUndefined($v_2)) {
        $v_3 = Xrm.Soap.CrmDateTimeSerializer.loadFromCrmSoap($v_2.get_domParserElement());
    }
    ...
    var $v_4 = data.selectSingleNode('.//a:KeyValuePairOfstringanyType[b:key=\'ReminderType\']/b:value/a:Value');
    var $v_5;
    if (!_Script.isNullOrUndefined($v_4)) {
        $v_5 = parseInt($v_4.get_innerText());
    }
    ...
    var $v_6 = data.selectSingleNode('.//a:KeyValuePairOfstringanyType[b:key=\'ReminderText\']/b:value');
    var $v_7 = (!_Script.isNullOrUndefined($v_6)) ? $v_6.get_innerText() : null;
    return new Xrm.Gen.SetReminderForEmailRequest($v_1, $v_3, $v_5, $v_7);
}
...
Xrm.Gen.DismissMissedEmailRequestSerializer = function() {
}
Xrm.Gen.DismissMissedEmailRequestSerializer.parametersToCrmSoap = function(request) {
    return Xrm.Soap.Write.f('MessageId', (request).messageId, 14);
}
Xrm.Gen.DismissMissedEmailRequestSerializer.loadFromCrmSoap = function(data) {
    if (_Script.isNullOrUndefined(data)) {
        return null;
    }
    return new Xrm.Gen.DismissMissedEmailRequest(Xrm.Soap.Parser.load(String, data, 'MessageId'));
}


Xrm.Gen.GetRegardingOpportunityIdRequestSerializer = function() {
}
Xrm.Gen.GetRegardingOpportunityIdRequestSerializer.parametersToCrmSoap = function(request) {
    return Xrm.Soap.Write.f('MessageId', (request).messageId, 14);
}
Xrm.Gen.GetRegardingOpportunityIdRequestSerializer.loadFromCrmSoap = function(data) {
    if (_Script.isNullOrUndefined(data)) {
        return null;
    }
    return new Xrm.Gen.GetRegardingOpportunityIdRequest(Xrm.Soap.Parser.load(String, data, 'MessageId'));
}


Xrm.Gen.GetRegardingOpportunityIdResponseSerializer = function() {
}
Xrm.Gen.GetRegardingOpportunityIdResponseSerializer.loadFromCrmSoap = function(soapResponse, request) {
    return Xrm.Soap.ResponseSerializer.deserialize(soapResponse, request, function($p1_0) {
        return new Xrm.Gen.GetRegardingOpportunityIdResponse(Xrm.Soap.Parser.load(Microsoft.Crm.Client.Core.Framework.Guid, $p1_0, 'OpportunityId'));
    });
}
...
Xrm.Gen.CopySharePointDocumentsRequestSerializer.parametersToCrmSoap = function(request) {
    return Xrm.Soap.Write.f('DestinationLocation', (request).destinationLocation, 14) + Xrm.Soap.Write.f('ParentEntityReference', (request).parentEntityReference, 6) + Xrm.Soap.Write.f('FolderPath', (request).folderPath, 14) + Xrm.Soap.Write.f('AbsoluteUrls', (request).absoluteUrls, -1, 'sa:ArrayOfstring', 'xmlns:sa=\"http://schemas.microsoft.com/2003/10/Serialization/Arrays\"') + Xrm.Soap.Write.f('RelativeUrls', (request).relativeUrls, -1, 'sa:ArrayOfstring', 'xmlns:sa=\"http://schemas.microsoft.com/2003/10/Serialization/Arrays\"') + Xrm.Soap.Write.f('Source', (request).source, 14);
}
Xrm.Gen.CopySharePointDocumentsRequestSerializer.loadFromCrmSoap = function(data) {
    if (_Script.isNullOrUndefined(data)) {
        return null;
    }
    return new Xrm.Gen.CopySharePointDocumentsRequest(Xrm.Soap.Parser.load(String, data, 'DestinationLocation'), Xrm.Soap.Parser.load(Xrm.Objects.EntityReference, data, 'ParentEntityReference'), Xrm.Soap.Parser.load(String, data, 'FolderPath'), Xrm.Soap.Parser.load(Array, data, 'AbsoluteUrls', 'StringArray'), Xrm.Soap.Parser.load(Array, data, 'RelativeUrls', 'StringArray'), Xrm.Soap.Parser.load(String, data, 'Source'));
}
...
Xrm.Gen.CopySharePointDocumentsResponseSerializer.loadFromCrmSoap = function(soapResponse, request) {
    return Xrm.Soap.ResponseSerializer.deserialize(soapResponse, request, function($p1_0) {
        return new Xrm.Gen.CopySharePointDocumentsResponse(Xrm.Soap.Parser.load(String, $p1_0, 'Status'));
    });
}
...
Xrm.Gen.AddOrEditLocationRequestSerializer.parametersToCrmSoap = function(request) {
    return Xrm.Soap.Write.f('LocationName', (request).locationName, 14) + Xrm.Soap.Write.f('AbsUrl', (request).absUrl, 14) + Xrm.Soap.Write.f('RelativePath', (request).relativePath, 14) + Xrm.Soap.Write.f('ParentType', (request).parentType, 14) + Xrm.Soap.Write.f('ParentId', (request).parentId, 14) + Xrm.Soap.Write.f('IsAddOrEditMode', (request).isAddOrEditMode, 0) + Xrm.Soap.Write.f('IsCreateFolder', (request).isCreateFolder, 0) + Xrm.Soap.Write.f('DocumentId', (request).documentId, 14) + Xrm.Soap.Write.f('ParentEntityReference', (request).parentEntityReference, 6);
}
Xrm.Gen.AddOrEditLocationRequestSerializer.loadFromCrmSoap = function(data) {
    if (_Script.isNullOrUndefined(data)) {
        return null;
    }
    return new Xrm.Gen.AddOrEditLocationRequest(Xrm.Soap.Parser.load(String, data, 'LocationName'), Xrm.Soap.Parser.load(String, data, 'AbsUrl'), Xrm.Soap.Parser.load(String, data, 'RelativePath'), Xrm.Soap.Parser.load(String, data, 'ParentType'), Xrm.Soap.Parser.load(String, data, 'ParentId'), Xrm.Soap.Parser.load(Boolean, data, 'IsAddOrEditMode'), Xrm.Soap.Parser.load(Boolean, data, 'IsCreateFolder'), Xrm.Soap.Parser.load(String, data, 'DocumentId'), Xrm.Soap.Parser.load(Xrm.Objects.EntityReference, data, 'ParentEntityReference'));
}
...
Xrm.Gen.FetchSiteUrlRequestSerializer.loadFromCrmSoap = function(data) {
    ...
    return new Xrm.Gen.FetchSiteUrlRequest(Xrm.Soap.Parser.load(String, data, 'DocumentId'), Xrm.Soap.Parser.load(Xrm.Objects.EntityReference, data, 'ParentEntityReference'));
}
...
Xrm.Gen.CompleteExchangeTaskRequestSerializer = function() {
}
Xrm.Gen.CompleteExchangeTaskRequestSerializer.parametersToCrmSoap = function(request) {
    return Xrm.Soap.Write.f('ExchangeTaskId', (request).exchangeTaskId, 14);
}
Xrm.Gen.CompleteExchangeTaskRequestSerializer.loadFromCrmSoap = function(data) {
    if (_Script.isNullOrUndefined(data)) {
        return null;
    }
    return new Xrm.Gen.CompleteExchangeTaskRequest(Xrm.Soap.Parser.load(String, data, 'ExchangeTaskId'));
}
...
Xrm.Gen.ValidateAppointmentRequestSerializer = function() {
}
Xrm.Gen.ValidateAppointmentRequestSerializer.parametersToCrmSoap = function(request) {
    return Xrm.Soap.Write.f('Target', (request).target, -1, 'a:Entity');
}
Xrm.Gen.ValidateAppointmentRequestSerializer.loadFromCrmSoap = function(data) {
    if (_Script.isNullOrUndefined(data)) {
        return null;
    }
    return new Xrm.Gen.ValidateAppointmentRequest(Xrm.Soap.Parser.load(Microsoft.Crm.Client.Core.Storage.Common.ObjectModel.EntityRecord, data, 'Target'));
}


Xrm.Gen.ValidateAppointmentResponseSerializer = function() {
}
Xrm.Gen.ValidateAppointmentResponseSerializer.loadFromCrmSoap = function(soapResponse, request) {
    return Xrm.Soap.ResponseSerializer.deserialize(soapResponse, request, function($p1_0) {
        return new Xrm.Gen.ValidateAppointmentResponse(Xrm.Soap.Parser.load(Xrm.Gen.ValidationResult, $p1_0, 'ValidationResult'));
    });
}
...
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.JsonSerializers.OrganizationSettingsSerializer.OrganizationSettingsRecord = function() {
    ...
    this.EnableMicrosoftFlowIntegration = false;
...
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.JsonSerializers.UserContextSerializer.loadFromJson = function(userContextJson) {
    ...
    for (var $$arr_6 = $v_0.UserRoles, $$len_7 = $$arr_6.length, $$idx_8 = 0; $$idx_8 < $$len_7; ++$$idx_8) {
        var $v_N = $$arr_6[$$idx_8];
        $v_4.add(new Microsoft.Crm.Client.Core.Framework.Guid($v_N));
    }
    ...
    if ($v_0.ParentRootRoles) {
        for (var $$arr_B = $v_0.ParentRootRoles, $$len_C = $$arr_B.length, $$idx_D = 0; $$idx_D < $$len_C; ++$$idx_D) {
            var $v_O = $$arr_B[$$idx_D];
            $v_5.add(new Microsoft.Crm.Client.Core.Framework.Guid($v_O));
        }
    }
    var $v_6 = $v_0.RoleNames;
    var $v_7 = Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.JsonSerializers.OrganizationSettingsSerializer.loadFromJson($v_0.OrganizationSettings);
    var $v_8 = Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.JsonSerializers.UserSettingsSerializer.loadFromJson($v_0.UserSettings);
    var $v_9 = Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.JsonSerializers.OfflineProfileSerializer.loadFromJson($v_0.OfflineProfile);
    var $v_A = new (Microsoft.Crm.Client.Core.Framework.TypedDictionary$1.$$(Microsoft.Crm.Client.Core.Storage.Common.ObjectModel.RolePrivilege))();
    for (var $$arr_K = $v_0.RolePrivileges, $$len_L = $$arr_K.length, $$idx_M = 0; $$idx_M < $$len_L; ++$$idx_M) {
        var $v_P = $$arr_K[$$idx_M];
        var $v_Q = Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.JsonSerializers.RolePrivilegeSerializer.loadFromJson($v_P);
        $v_A.set_item($v_Q.get_privilegeId().toString(), $v_Q);
    }
    ...
    for (var $$arr_Q = $v_0.AttributePrivileges, $$len_R = $$arr_Q.length, $$idx_S = 0; $$idx_S < $$len_R; ++$$idx_S) {
        var $v_R = $$arr_Q[$$idx_S];
        var $v_S = Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.JsonSerializers.AttributePrivilegeSerializer.loadFromJson($v_R);
        $v_B.set_item($v_S.get_attributeId().toString(), $v_S);
    }
    var $v_C = Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.JsonSerializers.ServerContextSerializer.loadFromJson($v_0.ServerContext);
    var $v_D = (_Script.isNullOrUndefined($v_0.FullServerVersion)) ? '' : $v_0.FullServerVersion;
    var $v_E = new Microsoft.Crm.Client.Core.Framework.Guid($v_0.TransactionCurrencyId);
    var $v_F = new Microsoft.Crm.Client.Core.Framework.Guid($v_0.DefaultDashboardId);
    var $v_G = new Microsoft.Crm.Client.Core.Framework.Guid($v_0.DefaultHomepageId);
    var $v_H = new Microsoft.Crm.Client.Core.Framework.Guid($v_0.DefaultInteractionCentricDashboardId);
    var $v_I = new (Microsoft.Crm.Client.Core.Framework.TypedDictionary$1.$$(Microsoft.Crm.Client.Core.Storage.Common.ObjectModel.TransactionCurrency))();
    for (var $$arr_c = $v_0.TransactionCurrencies, $$len_d = $$arr_c.length, $$idx_e = 0; $$idx_e < $$len_d; ++$$idx_e) {
        var $v_T = $$arr_c[$$idx_e];
        var $v_U = Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.JsonSerializers.TransactionCurrencySerializer.loadFromJson($v_T);
        $v_I.set_item($v_U.get_transactionCurrencyId().toString(), $v_U);
    }
    var $v_J = new (Microsoft.Crm.Client.Core.Framework.TypedDictionary$1.$$(Microsoft.Crm.Client.Core.Storage.Common.ObjectModel.TimeZoneDefinition))();
    for (var $$arr_i = $v_0.TimeZoneDefinitions, $$len_j = $$arr_i.length, $$idx_k = 0; $$idx_k < $$len_j; ++$$idx_k) {
        var $v_V = $$arr_i[$$idx_k];
        var $v_W = Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.JsonSerializers.TimeZoneDefinitionSerializer.loadFromJson($v_V);
        $v_J.set_item($v_W.get_timeZoneCode().toString(), $v_W);
    }
    var $v_K = {};
    $v_K['transactioncurrencybyid'] = $v_I;
    $v_K['timezonedefinitionbycode'] = $v_J;
    $v_K['islive'] = $v_0.IsLive;
    $v_K['isosdporganization'] = $v_0.IsOsdpOrganization;
    $v_K['usepathbasedurls'] = $v_0.UsePathBasedUrls;
    $v_K['entitymetadatasyncconfiguration'] = $v_0.EntityMetadataSyncConfiguration;
    var $v_L = {};
    var $$dict_r = $v_0.FCBContext;
    for (var $$key_s in $$dict_r) {
        var $v_X = { key: $$key_s, value: $$dict_r[$$key_s] };
        var $v_Y = Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.JsonSerializers.FeatureDetailsSerializer.loadFromJson($v_X.value);
        if (!_Script.isNullOrUndefined($v_Y)) {
            $v_L[$v_Y.get_featureName()] = $v_Y;
        }
    }
    var $v_M = new Microsoft.Crm.Client.Core.Storage.DataApi.UserContext($v_1, $v_2, $v_4.toArray(), $v_5.toArray(), $v_7, $v_8, $v_A, $v_B, $v_C, $v_6, $v_3, $v_E, $v_F, $v_G, $v_H, $v_D, $v_9, $v_K, $v_L);
    return $v_M;
}
...
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.Responses.CrmErrorResponse = function(request, textStatus, error, source) {
...
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.Responses.CrmErrorResponse.$23 = function() {
...
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.Responses.CrmErrorResponse.fromErrorCode = function(errorCode) {
    var $v_0 = Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.Responses.CrmErrorResponse.$23();
...
Microsoft.Crm.Client.Core.Storage.WebService.WebServiceBase = function(serverUri, authenticationManager, callerOriginProvider) {
    ...
    this.$B_0 = Microsoft.Crm.Client.Core.Storage.WebService.WebServiceBase.getNormalizedServerUrl(serverUri);
}
...
Microsoft.Crm.Client.Core.Storage.WebService.WebServiceBase.set_$2L = function($p0) {
...
Microsoft.Crm.Client.Core.Storage.WebService.WebServiceBase.prototype = {
    ...
    executeJsonRequest: function(requestData) {
        ...
        var $v_1 = this.get_name() + ' - ' + requestData.name;
        var $$t_7 = this, $$t_8 = this;
        this.$27_0(requestData).then(function($p1_0) {
            var $v_2 = $p1_0;
    ...
    $27_0: function($p0) {
        ...
        $v_4.start();
        var $$t_D;
        ($$t_D = Microsoft.Crm.Client.Core.Storage.WebService.WebServiceBase).set_$2L(Microsoft.Crm.Client.Core.Storage.WebService.WebServiceBase.$19 + 1);
        var $$t_G = this, $$t_H = this, $$t_I = this;
        $v_3.always(function($p1_0) {
            $v_4.stop();
            $$t_G.$3H_0($v_4, $p0, $p1_0);
            var $$t_E;
            ($$t_E = Microsoft.Crm.Client.Core.Storage.WebService.WebServiceBase).set_$2L(Microsoft.Crm.Client.Core.Storage.WebService.WebServiceBase.$19 - 1);
        }).then(function($p1_0) {
        ...
        var $v_5 = null;
        if (this.$1E_0) {
            $v_5 = this.$1E_0.getWebServiceCallRetryPolicy($p0.requestOptions.endPointUrl);
        }
        var $v_6 = ($v_5) ? $v_5.TotalRetryCount : 0;
        var $v_7 = ($v_5) ? $v_5.RetryWaitIntervalMilliseconds : 0;
        this.$p_0($v_0, $v_3, $v_6, $v_7, 0, 0, 5, $p0.requestOptions.doAuthentication);
        return $v_2.promise();
    },
    ...
    $p_0: function($p0, $p1, $p2, $p3, $p4, $p5, $p6, $p7) {
        if ($p7 && !_Script.isNullOrUndefined(this.$P_0)) {
            switch (this.$P_0.get_status()) {
                case 0:
                    this.$24_0($p0, $p1, $p2, $p3, $p4, $p5, $p6, $p7);
                    return;
                case 2:
                    $p1.reject(this.createErrorResponse(new XMLHttpRequest(), '', 'Authentication timed out'));
                    return;
            }
        }
        var $v_0 = $P_CRM.ajax($p0);
        var $$t_E = this, $$t_F = this;
        $v_0.success(function($p1_0) {
            if (_Script.isNullOrUndefined($p1_0)) {
                $p1.reject($$t_E.createErrorResponse(new XMLHttpRequest(), '', 'Response data null'));
            }
            else {
                var $v_1 = $$t_E.createResponseData($v_0, $p1_0);
                $p1.resolve($v_1);
            }
        }).error(function($p1_0, $p1_1, $p1_2) {
            if ($p1_0.status === 401 && !_Script.isNullOrUndefined($$t_F.$P_0)) {
                if ($p7) {
                    $$t_F.$24_0($p0, $p1, $p2, $p3, $p4, $p5, $p6, $p7);
                    $$t_F.$P_0.refreshAuthToken();
                }
                else {
                    $p1.reject($$t_F.createErrorResponse($p1_0, $p1_1, 'Not Authorized'));
                }
            }
            else if ($p1_0.status === 400 && $p4 < 5) {
                $$t_F.$1R_0($p0.url, $p1_0.status, $p1_2.toString(), 5 - $p4);
                ++$p4;
                $$t_F.$p_0($p0, $p1, $p2, $p3, $p4, $p5, $p6, $p7);
            }
            else if ($p1_0.status === 503 && $p2 > 0) {
                $$t_F.$1R_0($p0.url, $p1_0.status, $p1_2.toString(), $p2);
                --$p2;
                ...
                $$t_F.$1R_0($p0.url, $p1_0.status, $p1_2.toString(), 1 - $p5);
                ++$p5;
                $$t_F.$p_0($p0, $p1, $p2, $p3, $p4, $p5, $p6, $p7);
            }
            else if ($p1_0.status === 500 && $$t_F.canRetryServerError($$t_F.createErrorResponse($p1_0, $p1_1, $p1_2.toString())) && $p6 > 0) {
                $$t_F.$1R_0($p0.url, $p1_0.status, $p1_2.toString(), $p6 - 1);
                --$p6;
                window.setTimeout(function() {
                    $$t_F.$p_0($p0, $p1, $p2, $p3, $p4, $p5, $p6, $p7);
                }, 1000);
                ...
                Microsoft.Crm.Client.Core.Framework.DynamicsTrace.logInfo($$t_F.get_name() + '_ExecuteRequestWithRetry_Failure', 1005, String.format('Response: {0}, Exception: {1}', $p1_0.responseText, $p1_2.toString()));
                $$t_F.handleServiceError($p1, $p1_0, $p1_1, $p1_2);
            }
        });
    },
    ...
    $24_0: function($p0, $p1, $p2, $p3, $p4, $p5, $p6, $p7) {
        ...
        this.$f_0.done(function() {
            $$t_8.$p_0($p0, $p1, $p2, $p3, $p4, $p5, $p6, $p7);
        });
    },
...
Microsoft.Crm.Client.Core.Models.Validation.MultiSelectPicklistValidator.registerClass('Microsoft.Crm.Client.Core.Models.Validation.MultiSelectPicklistValidator', Microsoft.Crm.Client.Core.Models.Validation.IsRequiredValidator);
...
Xrm.Gen.DismissExchangeEnhancedActionCardsRequestSerializer.registerClass('Xrm.Gen.DismissExchangeEnhancedActionCardsRequestSerializer');
...
Xrm.Gen.IsLegacyCustomerRequestSerializer.registerClass('Xrm.Gen.IsLegacyCustomerRequestSerializer');
Xrm.Gen.IsLegacyCustomerResponseSerializer.registerClass('Xrm.Gen.IsLegacyCustomerResponseSerializer');
Xrm.Gen.GetAciMarsConnectorStatusRequestSerializer.registerClass('Xrm.Gen.GetAciMarsConnectorStatusRequestSerializer');
Xrm.Gen.GetAciMarsConnectorStatusResponseSerializer.registerClass('Xrm.Gen.GetAciMarsConnectorStatusResponseSerializer');
...
Xrm.Gen.SnoozeExchangeActionCardsRequestSerializer.registerClass('Xrm.Gen.SnoozeExchangeActionCardsRequestSerializer');
...
Xrm.Gen.SubmitImportedDataRequestSerializer.registerClass('Xrm.Gen.SubmitImportedDataRequestSerializer');
Xrm.Gen.SubmitImportedDataResponseSerializer.registerClass('Xrm.Gen.SubmitImportedDataResponseSerializer');
Xrm.Gen.CreateDocumentLibrariesRequestSerializer.registerClass('Xrm.Gen.CreateDocumentLibrariesRequestSerializer');
Xrm.Gen.CreateFolderAndNewDocumentsRequestSerializer.registerClass('Xrm.Gen.CreateFolderAndNewDocumentsRequestSerializer');
Xrm.Gen.CreateFolderAndNewDocumentsResponseSerializer.registerClass('Xrm.Gen.CreateFolderAndNewDocumentsResponseSerializer');
...
Xrm.Gen.RetrieveActiveStageRecordRequestSerializer.registerClass('Xrm.Gen.RetrieveActiveStageRecordRequestSerializer');
Xrm.Gen.RetrieveActiveStageRecordResponseSerializer.registerClass('Xrm.Gen.RetrieveActiveStageRecordResponseSerializer');
...
Xrm.Gen.UploadDocumentRequestSerializer.registerClass('Xrm.Gen.UploadDocumentRequestSerializer');
...
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated.SetDelaySendForEmailRequestSerializer.registerClass('Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated.SetDelaySendForEmailRequestSerializer');
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated.SetReminderForEmailRequestSerializer.registerClass('Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated.SetReminderForEmailRequestSerializer');
...
Xrm.Gen.DismissMissedEmailRequestSerializer.registerClass('Xrm.Gen.DismissMissedEmailRequestSerializer');
Xrm.Gen.GetRegardingOpportunityIdRequestSerializer.registerClass('Xrm.Gen.GetRegardingOpportunityIdRequestSerializer');
Xrm.Gen.GetRegardingOpportunityIdResponseSerializer.registerClass('Xrm.Gen.GetRegardingOpportunityIdResponseSerializer');
...
Xrm.Gen.CompleteExchangeTaskRequestSerializer.registerClass('Xrm.Gen.CompleteExchangeTaskRequestSerializer');
...
Xrm.Gen.ValidateAppointmentRequestSerializer.registerClass('Xrm.Gen.ValidateAppointmentRequestSerializer');
Xrm.Gen.ValidateAppointmentResponseSerializer.registerClass('Xrm.Gen.ValidateAppointmentResponseSerializer');
...
Microsoft.Crm.Client.Core.Models.Validation.EmailAddressValidator.$1y = new RegExp('^[^@\\s\\\"<>)(\\[\\]:;,]+@[^@\\s\\\"<>)(\\[\\]:;,]+$');
Microsoft.Crm.Client.Core.Models.Validation.EmailAddressValidator.$21 = new RegExp('[\\\\\"]');
...
Xrm.Soap.CrmDateTimeSerializer.$1z = null;
...
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated.SetDelaySendForEmailRequestSerializer.$$cctor();
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated.SetReminderForEmailRequestSerializer.$$cctor();
